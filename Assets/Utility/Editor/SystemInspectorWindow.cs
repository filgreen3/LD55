...
namespace Filgreen3.SystemController.Editor
{
    public abstract class SystemInspectorWindow : EditorWindow
    {
        ...
        protected void AddSystem()
        {
            ...
            var type = GetTypeFromAssembley(GetSystems(_assembles[_assemblyID])[_typeID], assembly);
            var obj = new GameObject(type.Name, type);
            obj.transform.SetParent(_systemsContainer.transform);
        ...
        protected Type GetTypeFromAssembley(string typeName, Assembly assembly)
        {
