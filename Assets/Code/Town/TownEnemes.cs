...
public class TownEnemes : ITownComponent
{
    ...
    public void Generate(TownGenerator generator)
    {
        ...
        {
            var character = GameObject.Instantiate(Characters[Random.Range(0, Characters.Length)], generator.CenterPosition + Vector3.right * Random.Range(-generator.Size, generator.Size), Quaternion.identity);
