...
[System.Serializable]
public class FixedPattletPostProcessPass : ScriptableRenderPass
{
    ...
    public FixedPattletPostProcessPass(Shader shader)
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        var materials = new Material(_defShader);
        if (materials == null)
        {
        ...
        //---Custom effect here---
        var customEffect = stack.GetComponent<FixedPattletEffectComponent>();
        // Only process if the effect is active
        if (customEffect.IsActive())
        {
            var material = materials;
            // P.s. optimize by caching the property ID somewhere else
            material.SetFloat(Shader.PropertyToID("_ColorCount"), customEffect.colorCount.value);
            material.SetTexture(Shader.PropertyToID("_Palette"), customEffect.pallet.value);
            material.SetColor(Shader.PropertyToID("_BaseColor"), customEffect.baseColor.value);
